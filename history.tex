Refsdal \cite[Ref64] first suggested in 1964 that lens time delays
could be used to measure absolute distances out to cosmological
distances, and therefore the Hubble Constant to leading
order. Unfortunately, no strong lensing systems were known at that
time, and therefore his intuition remained purely theoretical for over
a decade.
...
\cite{CSS02}
, and the first truly robust time delays were measured
\cite{Kun++97,Sch++97}. 
