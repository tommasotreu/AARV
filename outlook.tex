...
represents the estimated range of uncertainty attainable on $\Ddt$ as a
function of time, over the next ten years. As discussed in
Section~\ref{ssec:roadmap}, this region is intended to span
the most conservative to the most favorable scenarios.
The roadmap is divided into steps, whose timing is dictated by
available observational facilities. The
second step of the roadmap aims to deliver $\sim2\%$ precision by the
launch of JWST, using data in hand. The third step aims to deliver
$\sim1\%$ with the completion of follow-up (FLP) observations of lenses discovered in
Stage~3 imaging surveys such as the Dark Energy survey. The fourth step
aims to reach $\sim0.5\%$ precision, through follow-up of systems discovered
and monitored in the first five years of the LSST survey. Converting the uncertainty
...
diameter distance \citep{JeeEtal2016}.  As
...
as a conservative estimate. The first step in the roadmap is the analysis
...
systems should be sufficient to reach the goal for step 3, that is, 40
