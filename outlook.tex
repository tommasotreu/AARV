...
While the single-filter results of TDC1 are encouraging, questions
about our ability to measure time delays from sparse, multi-filter light
curves remain. Time delay measurement accuracy from  LSST multi-filter
...
\citep[e.g.][]{SchmidtEtal} and chromatic  microelensing
\citep[e.g.][]{Hicksen}. Joint inference from whole samples is likely to
...
progress \citep{Courbin,McCully}.
