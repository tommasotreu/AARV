...
regularization is effectively achieved through choosing the number of basis
functions to use as well as the scale of the underlying Gaussian. An
alternative scheme would be to assign a less uninformative prior for the
shapelet coefficients, but this has not yet been tested.}
Hybrid approaches have been proposed where some of
