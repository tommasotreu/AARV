...
the Hubble constant has now been measured to 3\% precision while the
distance to the last scattering surface of the cosmic microwave
backgrond is now known to 1\% precision. This precision is more than
sufficient for all purposes related to our understanding of phenomena
occurring within the universe, like galaxy evolution.
...
it a dynamical component? Answering this question will require further
improvements in the precision of distance measurements
\cite{Wei++13}. Many dedicated experiments are currently under way of
being planned with ths goal in mind.

Precision alone, however, is not sufficient by itself. In addition to
controlling the known statistical uncertainties, modern day
experiments need to control stystematic errors ({\it accuracy}) in
order to fullfill their potential, including the infamous unknow
unknowns. For this reason, the community is pursuing several
independent probes of dark energy
