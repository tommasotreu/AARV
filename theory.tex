...
density or convergence $\kappa=\Sigma/\Sigma_c$. The latter can be defined,
even for
axisymmetric mass distributions, as
the radius of the circle within which the mean convergence
...
\citep{Hol01}. This way requires special circumstances, and therefore
