...
\Dd\Dds$, and it is used to define the dimensionless surface mass density or convergence $\kappa=\Sigma/\Sigma_c$. The latter can be defined as 
the radius of the circle within which $\langle $\kappa \rangle=1$, for
axisymmetric mass distributions.
